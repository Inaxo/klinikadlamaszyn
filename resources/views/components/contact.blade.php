...
<section class="relative z-10 overflow-hidden bg-white py-20 lg:py-[250px]">
    <div class="container mx-auto">
        <div class="-mx-4 flex flex-wrap lg:justify-between">
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div class="mb-12 max-w-[570px] lg:mb-0">
          <span class="text-[#637381] mb-4 block text-base font-semibold">
            Kontakt
          </span>
                    <h2
                    ...
                    <p class="text-body-color mb-9 text-base leading-relaxed">
                        Zapraszamy do kontaktu z nami. Odpowiemy na wszystkie pytania i wątpliwości. Wypełnij formularz kontaktowy lub skontaktuj się z nami telefonicznie.
                    </p>
                    <div class="mb-8 flex w-full max-w-[370px]">
                        ...
                        >
                            <svg
                                ...
                                height="24"
                                viewBox="0 0 24 24"
                                class="fill-current text-[#637381]"
                            >
                                <path
                        ...
                        <div class="w-full">
                            <h4 class="text-dark mb-1 text-xl font-bold">Adres</h4>
                            <p class="text-body-color text-base">
                                Katowice Wojciecha 1
                            </p>
                        </div>
                    </div>
                    <div class="mb-8 flex w-full max-w-[370px]">
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-body-color text-base">+48 691 646 362</p>
                        </div>
                    </div>
                    <div class="mb-8 flex w-full max-w-[370px]">
                        <div
                        ...
                        <div class="w-full">
                            <h4 class="text-dark mb-1 text-xl font-bold">Adres e-mail</h4>
                            <p class="text-body-color text-base">biuro@klinikadlamaszyn.pl</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                    ...
                    <form>
                        <div class="mb-6">
                            <input
                                ...
                                class="text-body-color border-[f0f0f0] focus:border-[#637381] w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                            />
                        </div>
                        <div class="mb-6">
                            <input
              ...
              ></textarea>
                        ...
                        <div>
                            <button
                                type="submit"
                                class="bg-[#111827]  w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                            >
                                Wyślij wiadomość
                            </button>
                        </div>
