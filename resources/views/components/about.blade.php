...
<div id="about" class="relative bg-white overflow-hidden ">
    ...
    <div class="max-w-7xl mx-auto lg:pr-1/2">
        <div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
            ...
            <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28 lg:mr-32">
            <div class="sm:text-center lg:text-left">
                    ...
                    <p>
                       <p>Ka&#380;dy klient otrzymuje od nas pakiet wiedzy technicznej po naprawie &ndash; , kt&oacute;ry jest niezb&#281;dny do dalszej i bezawaryjnej obs&#322;ugi maszyny. Szkolenie techniczne z obs&#322;ugi naprawianej u nas maszyny zapewniamy ka&#380;demu klientowi !</p>

<p>W jakiej cenie? 0 z&#322;.</p>

<p> Przede wszystkim zale&#380;y nam na tym, &#380;eby maszyny s&#322;u&#380;y&#322;y wiele lat a nie wraca&#322;y co kilka miesi&#281;cy do naprawy. Dzi&#281;ki wsp&oacute;&#322;pracy z zaprzyja&#378;nionym centrum CNC jeste&#347;my w stanie odtworzy&#263; niedost&#281;pn&#261; ju&#380; na rynku cz&#281;&#347;&#263; zamienn&#261; do unikatowych maszyn do szycia.</p>
                    </p>
                </div>
            </main>
        </div>
